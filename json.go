...
func (b Bulb) MarshalJSON() ([]byte, error) {
	...
	if b.info != nil {
		index["info"] = map[string]interface{}{
			...
			"time": b.info.Time.Nanoseconds(),
			"uptime": b.info.UpTime.Nanoseconds(),
		}
	}
	...
	if b.location != nil {
		index["location"] = map[string]interface{}{
			...
			"location": string(b.location.Location),
			"updatedat": b.location.UpdatedAt.Nanoseconds(),
		}
	}
	...
	if b.group != nil {
		index["group"] = map[string]interface{}{
			"label": b.group.Label,
			"location": string(b.group.Location),
			"updatedat": b.group.UpdatedAt.Nanoseconds(),
		}
	}
